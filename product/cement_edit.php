...
<body>
    ...
    $sql = "SELECT * FROM cement INNER JOIN product ON cement.product_id = product.product_id  WHERE cement.product_id = '" . $idproduct . "' ORDER BY cement.product_id ASC";
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" name="editform" id="editform" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div>
                                <input class="w3-button w3-black w3-round-xlarge" type="submit" name="back" value="ย้อนกลับ" style="width: 100px" onclick="document.editform.action='cement_show.php'">
                                <input class="w3-button w3-red w3-round-xlarge" type="submit" name="update" value="บันทึก" style="width: 100px" onclick="document.editform.action='cement_update.php'">
                            </div>
                        </form>
                    </div>
                </div>
