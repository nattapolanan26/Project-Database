...
<?php include('../connectdb.php'); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" name="addcostprice" id="addcostprice" method="post" enctype="multipart/form-data">
                            ...
                            $sql = "SELECT product.*,cement.*,brand.brand_name,unit.unit_name,color.color_name
                    FROM product
    ...
    if (isset($_POST['addcostprice'])) {
        ...
        $Sqlsaleprice = "SELECT product.product_saleprice FROM product INNER JOIN cement ON product.product_id = cement.product_id WHERE product.product_id = '$idproduct'";
        ...
        if ($_POST['company'] && $_POST['costprice'] != '') {
            if ($_POST['costprice'] <  0) {
                ...
                echo "window.location.href='cement_costprice.php?p_id=$productid'"; //แสดงหน้าก่อนนี้
                echo "</script>";
