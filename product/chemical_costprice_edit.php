...
<body>
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="chemical_costprice_show.php?p_id=<?= $productid; ?>&cmc_id=<?= $cmcid; ?>" class="btn-danger btn-sm">ย้อนกลับ</a>
                        <form action="#" name="editcostprice" id="editcostprice" method="post" enctype="multipart/form-data">
                            <p></p>
                            <?php
                            $sql = "SELECT product_name,chemicalsolution.*,brand.brand_name,unit.unit_name,product.*,costprice
                    FROM product
                    ...
                    WHERE chemicalsolution.product_id = '$productid' AND costprice.cpn_id = '$cpnid'
                    ";
    ...
    if (isset($_POST['editcostprice'])) {
        ...
        if ($result = mysqli_query($conn, $sql)) {
            ...
            echo "window.location.href='chemical_costprice_show.php?p_id=$productid';";
            echo "</script>";
        } else {
            echo "<script>";
