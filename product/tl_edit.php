...
<head>
    ...
    <script type="text/javascript">
        function submitupdate() {
            document.editform.action = "mortar_update.php";
        }
...
<?php
    ...
    $sql = "SELECT * FROM toilet INNER JOIN product ON toilet.product_id = product.product_id  WHERE product.product_id ='" . $idproduct . "' ORDER BY product.product_id ASC";
                            ...
                            <form action="#" name="editform" id="editform" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-2 mb-3 control-label">
                                        <label for="validationDefault04">ขนาด<a style="color:red;"> (กว้าง*ลึก*สูง)</a></label>
                                ...
                                <div>
                                    <input class="w3-button w3-black w3-round-xlarge" type="submit" name="back" value="ย้อนกลับ" style="width: 100px" onclick="document.editform.action='tl_show.php'">
                                    <input class="w3-button w3-red w3-round-xlarge" type="submit" name="update" value="บันทึก" style="width: 100px" onclick="document.editform.action='tl_update.php'">
                                </div>
                            </form>
                        </div>
                    </div>
