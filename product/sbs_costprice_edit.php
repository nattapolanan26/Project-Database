...
<?php include('../connectdb.php'); ?>
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="sbs_costprice_show.php?p_id=<?= $productid; ?>" class="btn-danger btn-sm">ย้อนกลับ</a>
                        <form action="#" name="editcostprice" id="editcostprice" method="post" enctype="multipart/form-data">
                            <p></p>
                            <?php

                            $sql = "SELECT product.*,brand.brand_name,unit.unit_name,costprice.costprice
                    FROM product
                    ...
                    ";
                            ...
                            <div class="form-row">
                                <div class="col-sm-2 mb-3">
                                    ...
                                    <small id="costpriceHelp" class="form-text text-muted" style="color:red;">*กรุณาใส่ราคาทุนที่จะแก้ไข*</small>
                                </div>
                            </div>
    ...
    if (isset($_POST['editcostprice'])) {
        ...
        if ($result = mysqli_query($conn, $sql)) {
            ...
            echo "window.location.href='sbs_costprice_show.php?p_id=$productid';";
            echo "</script>";
        } else {
            echo "<script>";
