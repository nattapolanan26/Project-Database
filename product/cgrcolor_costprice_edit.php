...
<body>
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="cgrcolor_costprice_show.php?p_id=<?= $productid; ?>" class="btn-danger btn-sm">ย้อนกลับ</a>
                        <form action="#" name="editcostprice" id="editcostprice" method="post" enctype="multipart/form-data">
                            <p></p>
                            <?php
                            $sql = "SELECT product.*,categorycolor.*,brand.brand_name,unit.unit_name,costprice.costprice,color.color_name,cc_volume
                    FROM product
                    ...
                    ";
                            ...
                            <div class="form-row">
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo $productname . " " . $brandname . " " . "สี" . $color . " " . $volume . " " . "ราคา" . " " . number_format($saleprice, 2); ?>" disabled>
                                </div>
                            </div>
    ...
    if (isset($_POST['editcostprice'])) {
        ...
        if ($result = mysqli_query($conn, $sql)) {
            ...
            echo "window.location.href='cgrcolor_costprice_show.php?p_id=$productid';";
            echo "</script>";
        } else {
            echo "<script>";
