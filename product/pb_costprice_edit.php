...
<body>
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="pb_costprice_show.php?p_id=<?= $productid; ?>" class="btn-danger btn-sm">ย้อนกลับ</a>
                    ...
                    WHERE plumbling.product_id = '$productid' AND costprice.cpn_id = '$cpnid'
                    ";
                            ...
                            <div class="form-row">
                                <div class="col-sm-5 mb-3">
                                    ...
                                    <input class="form-control" type="text" value="<?= htmlspecialchars($product_name . " " . $brand_name . " " . $class . " " . $pb_thick . " " . "ขนาด" . " (" . $pb_size . ") " . "ราคา" . " " . number_format($product_saleprice, 2)); ?>" disabled>
                                </div>
                            </div>
    ...
    if (isset($_POST['editcostprice'])) {
        ...
        $sql = "UPDATE costprice SET costprice='" . $costprice . "' WHERE product_id = '" . $productid . "' AND cpn_id = '" . $_GET['cpn_id'] . "'";
