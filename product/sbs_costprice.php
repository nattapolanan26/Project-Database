...
<?php include('../connectdb.php'); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" name="addcostprice" id="addcostprice" method="post" enctype="multipart/form-data">
                            ...
                            $sql = "SELECT product.*,brand.brand_name,unit.unit_name
                    FROM product
                    ...
                    WHERE product.product_id = '$productid'";
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo $productname . " " . $brandname . " " . "ราคาขาย" . " " . number_format($saleprice, 2); ?>" disabled>
                                </div>
                            </div>
    ...
    if (isset($_POST['addcostprice'])) {
        ...
        //select ค่าจากราคาขาย มาเช็ค
        $Sqlsaleprice = "SELECT product_saleprice FROM product WHERE product_id = '$idproduct'";
        ...
        if ($_POST['company'] && $_POST['costprice'] != '') {
            if ($_POST['costprice'] <  0) {
                ...
                echo "window.location.href='sbs_costprice.php?p_id=$idproduct'"; //แสดงหน้าก่อนนี้
                echo "</script>";
                ...
                if ($result = mysqli_query($conn, $sql)) {
                    echo "<script>"; //คำสั่งสคิป
                    echo "window.location.href='sbs_show.php';"; //แสดงหน้าก่อนนี้
                    echo "</script>";
                } else {
                    echo "<script>"; //คำสั่งสคิป
