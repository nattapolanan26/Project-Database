...
<body>
                        ...
                        <form action="#" id="myformAdd" name="myformAdd" method="post">
                            ...
                            <div class="form-row">
                                <div class="col-sm-2 mb-3 control-label">
                                    <label for="validationDefault08">ขนาด</label>
                                    <input class="form-control" type="text" name="size" value="<?php if (isset($_POST['size'])) echo $_POST['size']; ?>">
                                    <small id="salepriceHelp" class="form-text text-muted"><a style="color:red;">*กรุณาใส่ขนาดสินค้า*</a></small>
                                </div>
                                <div class="col-sm-2 mb-3 control-label">
                            ...
                            <div>
                                <input class="w3-button w3-black w3-round-xlarge" type="submit" name="cgrcolorback" value="ย้อนกลับ" style="width: 100px" onclick="document.myformAdd.action='ct_show.php'">
    ...
    if (isset($_POST['submitcolor'])) {
        ...
        if ($p_name == '0' && $c_color == '0' && $b_brand == '0' && $m_mateial == '0' && $s_size == '0' && $name != '' && $saleprice != '' && $unit != '' && $brand != '' && $repoint != '' && $size != '' && $material != '') {
            $sql = "INSERT INTO product (product_id,product_name,brand_id,unit_id,product_saleprice,product_reorder,product_stock,product_detail,product_status) VALUES ('$idproduct','$name','$brand','$unit','$saleprice','$repoint','0','$detail','5')";
            // echo $sql;
            if (mysqli_query($conn, $sql) == true) {
                $sql1 = "INSERT INTO craftmantool (product_id,color_id,mt_id,ct_size) VALUES ('$idproduct','$color','$material','$size')";
                ...
                echo "window.location.href='ct_insert.php';"; //แสดงหน้าก่อนนี้
                echo "</script>";
            }
        } elseif ($name == '' || $saleprice == '' || $unit == '' || $brand == '' || $repoint == '' || $material == '' || $detail == '' || $size == '') {
            echo "<script>";
            echo "alert('กรุณากรอกข้อมูลให้ครบ !!');";
            echo "window.location.href='ct_insert.php';";
            echo "</script>";
        } else {
            echo "<script>";
