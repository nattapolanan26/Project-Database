...
<?php
    ...
    $sql = "SELECT * FROM craftmantool INNER JOIN product ON craftmantool.product_id = product.product_id WHERE craftmantool.product_id = '" . $idproduct . "'";
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" name="editform" id="editform" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div>
                                <input class="w3-button  w3-black w3-round-xlarge mb-3" type="submit" name="cgrcolorback" value="ย้อนกลับ" style="width: 100px" onclick="document.editform.action='ct_show.php'">
                                <input class="w3-button w3-red w3-round-xlarge mb-3" type="submit" name="update" value="บันทึก" style="width: 100px" onclick="document.editform.action='ct_update.php'">
                            </div>
                        </form>
                    </div>
                </div>
