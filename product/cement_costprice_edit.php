...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        <h4>แก้ไขราคาทุนและบริษัทคู่ค้า</h4>
                        <?php
                        $productid = isset($_GET['p_id']) ? $_GET['p_id'] : '';
                        $cpnid = isset($_GET['cpn_id']) ? $_GET['cpn_id'] : '';
                        ?>
                        <a href="cement_costprice_show.php?p_id=<?= $productid; ?>" class="btn-danger btn-sm">ย้อนกลับ</a>
                        <form action="#" name="editcostprice" id="editcostprice" method="post" enctype="multipart/form-data">
                            <p></p>
                            <?php
                            $sql = "SELECT product.*,cement.*,brand.brand_name,unit.unit_name,costprice.costprice,color_name
                    FROM product
    ...
    if (isset($_POST['editcostprice'])) {
        ...
        if ($result = mysqli_query($conn, $sql)) {
            ...
            echo "window.location.href='cement_costprice_show.php?p_id=$productid';";
            echo "</script>";
        } else {
            echo "<script>";
