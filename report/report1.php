  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <div class="card">
          <div class="card-body">
            <h5 class="card-header"><i class="far fa-file-alt"></i> สรุปรายรับ - รายจ่าย</h5>
            <p></p>
            <form>
              <div class="form-row align-items-center d-flex justify-content-center">
                <div class="col-auto">
                  <input type="text" name="datefilter" id="from_date" value="" class="form-control mb-2" style="width:300px" placeholder="เริ่มต้นวันที่    -    สิ้นสุดวันที่" />
                </div>
                <div class="col-auto">
                  <button type="button" name="filter" id="filter" value="Filter" class="btn btn-info mb-2 btn-block" style="width:50px"><i class="fas fa-search"></i></button>
                </div>
              </div>

              <div class="table-responsive">
                <input type="hidden" id="income_date">
                <center><span style="color:red;" id="show_date_income"></span></center>
                <p></p>
                <p></p>
